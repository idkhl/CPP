...
ShrubberyCreationForm::ShrubberyCreationForm(std::string target): AForm("Shrubbery Creation Form", 72, 45) {
    this->_target = target;
    std::cout << "Shrubbery Creation Form has been created regarding " << this->_target << std::endl;
}
